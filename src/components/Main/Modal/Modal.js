    ...
    <>
      <div className={styles.backdrop}>
        {data.map(
          (obj) =>
            obj.ID === currentId && (
              <div key={obj.ID} className={styles.modal}>
                <span className={styles.modalCountryName}>{obj.Country}</span>
                <div className={styles.modalWrapInfo}>
                  <p className={styles.modalText}>
                    <span className={styles.modalImg}>
                      <svg
                        width="30"
                        height="28"
                        viewBox="0 0 30 28"
                  ...
                  <p className={styles.modalText}>
                    ...
                    Total Deaths <span>{obj.TotalDeaths}</span>
                  </p>
                  <p className={styles.modalText}>
                    <span className={styles.modalImg}>
                      <svg
                    ...
                    Total Recovered <span>{obj.TotalRecovered}</span>
                  </p>
                </div>
                <button
